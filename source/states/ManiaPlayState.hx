...
class ManiaPlayState extends MusicBeatState
{
	// song stuff
	...
	override public function create()
	{
        ...
        var underlay = new FlxSprite().loadGraphic(Paths.image("hud/base/mania"));
        underlay.screenCenter();
		underlay.scrollFactor.set();
		backGroup.add(underlay);
		...
		DiscordClient.changePresence("Playing: " + SONG.song.toUpperCase().replace("-", " ") + " MANIA", null);
