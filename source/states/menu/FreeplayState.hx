...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		addWeek(["euphoria", "nefarious", "divergence"], ["bella", "bex", "duo"]);
		addWeek(["allegro", "panic-attack", "convergence", "desertion"], ["bella", "bree", "bree", "angry-bree"]);
		addSong("sin", "helica");
		addSong("conservation", "watts");
